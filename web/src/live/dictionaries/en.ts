...
const en = {
	...
	"Anyone with the name": "Anyone with the name",
	"Typing the name is enough. Somebody who guesses a short name is in the meeting.": "Typing the name is enough. Somebody who guesses a short name is in the meeting.",
