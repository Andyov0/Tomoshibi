...
const en = {
	...
	"Could not copy the link. Copy it from the box.": "Could not copy the link. Copy it from the box.",
	"That is more than sixty days away.": "That is more than sixty days away.",
	...
	"That time has already gone.": "That time has already gone.",
	"Arranged for {when}": "Arranged for {when}",
	"Your meeting can start from {when}.": "Your meeting can start from {when}.",
	"Could not reach the meeting. Trying again.": "Could not reach the meeting. Trying again.",
	"Ask again": "Ask again",
	"Your session has expired. Sign in again.": "Your session has expired. Sign in again.",
	"Schedule a meeting": "Schedule a meeting",
	"Pick a time and hand out the link before it starts.": "Pick a time and hand out the link before it starts.",
	"Arrange": "Arrange",
	"Cancel meeting": "Cancel meeting",
	"Over": "Over",
	"Under way": "Under way",
	"Wait for the host": "Wait for the host",
	"Start the meeting": "Start the meeting",
	"Waiting for the host to start the meeting.": "Waiting for the host to start the meeting.",
	"The host has not started this meeting.": "The host has not started this meeting.",
	"This meeting is arranged for {when}.": "This meeting is arranged for {when}.",
	"Your meeting is arranged for {when}. Joining starts it.": "Your meeting is arranged for {when}. Joining starts it.",
	"That room already has a meeting arranged.": "That room already has a meeting arranged.",
	"That time is not one a meeting can be arranged for.": "That time is not one a meeting can be arranged for.",
	"Meetings here ask for an account, so a link cannot let anybody in.": "Meetings here ask for an account, so a link cannot let anybody in.",
	"That is somebody else's room.": "That is somebody else's room.",
	"You have as many meetings arranged as you can have.": "You have as many meetings arranged as you can have.",
	"Only whoever runs this room can let somebody else in.": "Only whoever runs this room can let somebody else in.",
	"Controls": "Controls",
	"Always shown": "Always shown",
	"Hide when nothing is happening": "Hide when nothing is happening",
	"At the side": "At the side",
	"Blur my background": "Blur my background",
	"Show my background": "Show my background",
	"Background": "Background",
	"Blurred": "Blurred",
	"Not blurred": "Not blurred",
	"Somebody is waiting to be let in": "Somebody is waiting to be let in",
	"{count} people are waiting to be let in": "{count} people are waiting to be let in",
	"Answer": "Answer",
	"Waiting to be let in": "Waiting to be let in",
	"Let in": "Let in",
	"Not now": "Not now",
	"Ask to be let in": "Ask to be let in",
	"Waiting for somebody to let you in.": "Waiting for somebody to let you in.",
	"Nobody let you in. Ask for a link.": "Nobody let you in. Ask for a link.",
	"That could not be sent.": "That could not be sent.",
	"Raise your hand": "Raise your hand",
	"Lower your hand": "Lower your hand",
	"Reactions": "Reactions",
	...
	"Anybody with a passphrase": "Anybody with a passphrase",
