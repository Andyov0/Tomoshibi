...
const ja: Dictionary = {
	...
	"Could not copy the link. Copy it from the box.": "リンクをコピーできませんでした。下のボックスからコピーしてください。",
	"That is more than sixty days away.": "60 日より先は予約できません。",
	"Meeting link": "会議リンク",
	"Day": "日付",
	"Time": "時刻",
	"Hour": "時",
	...
	"Previous month": "前の月",
	"Next month": "次の月",
	"Choose a day.": "日を選んでください。",
	"That time has already gone.": "その時刻はもう過ぎています。",
	"Arranged for {when}": "{when} に予定",
	"Your meeting can start from {when}.": "この会議は {when} から開始できます。",
	"Could not reach the meeting. Trying again.": "会議に接続できません。再試行しています。",
	"Ask again": "もう一度確認",
	"Your session has expired. Sign in again.": "セッションが切れました。もう一度サインインしてください。",
	"Schedule a meeting": "会議を予約する",
	"Pick a time and hand out the link before it starts.": "時刻を決めて、開始前にリンクを配れます。",
	"Arrange": "予約",
	"Cancel meeting": "会議を取り消す",
	"Over": "終了",
	"Under way": "進行中",
	"Wait for the host": "進行役を待つ",
	"Start the meeting": "会議を始める",
	"Waiting for the host to start the meeting.": "進行役が会議を始めるのを待っています。",
	"The host has not started this meeting.": "進行役はまだこの会議を始めていません。",
	"This meeting is arranged for {when}.": "この会議は {when} に予定されています。",
	"Your meeting is arranged for {when}. Joining starts it.": "あなたの会議は {when} に予定されています。参加すると開始します。",
	"That room already has a meeting arranged.": "この部屋にはすでに会議が予約されています。",
	"That time is not one a meeting can be arranged for.": "その時刻には会議を予約できません。",
	"Meetings here ask for an account, so a link cannot let anybody in.": "ここの会議はアカウントが必要なため、リンクでは入室できません。",
	"That is somebody else's room.": "それは他の人の部屋です。",
	"You have as many meetings arranged as you can have.": "予約できる会議の数が上限に達しています。",
	"Only whoever runs this room can let somebody else in.": "この部屋に人を入れられるのは、進行役だけです。",
	"Controls": "操作バー",
	"Always shown": "常に表示",
	"Hide when nothing is happening": "操作がなければ隠す",
	"At the side": "画面の端に置く",
	"Blur my background": "背景をぼかす",
	"Show my background": "背景を表示する",
	"Background": "背景",
	"Blurred": "ぼかし中",
	"Not blurred": "ぼかさない",
	"Somebody is waiting to be let in": "入室を待っている人がいます",
	"{count} people are waiting to be let in": "{count} 人が入室を待っています",
	"Answer": "応対する",
	"Waiting to be let in": "入室待ち",
	"Let in": "入れる",
	"Not now": "今はしない",
	"Ask to be let in": "入室をお願いする",
	"Waiting for somebody to let you in.": "中の人が入れてくれるのを待っています。",
	"Nobody let you in. Ask for a link.": "誰も入れてくれませんでした。リンクをもらってください。",
	"That could not be sent.": "送信できませんでした。",
	"Raise your hand": "挙手",
	"Lower your hand": "手を下ろす",
	"Reactions": "リアクション",
	...
	"Forget it?": "削除しますか?",
	"Forget": "削除",
	"Forget {room}": "{room} を削除",
	"Anybody with a passphrase": "合言葉を決めた人なら誰でも",
